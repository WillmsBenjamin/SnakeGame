...
public class FruitOptionsMenu extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 166364521463438643L;
	...
	protected void noButtonActionPerformed() {
		...
		Game.game.setState(GameState.GAPS_MENU);
	}
